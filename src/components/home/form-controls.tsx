...
export function SubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="h-[50px] w-full rounded-[14px] bg-green text-[16px] font-semibold text-white shadow-[0_8px_20px_-10px_rgba(6,96,63,0.6)] transition-[transform,box-shadow] duration-200 ease-brand hover:-translate-y-px hover:shadow-[0_14px_26px_-12px_rgba(6,96,63,0.7)] disabled:pointer-events-none disabled:opacity-60 disabled:shadow-none"
    >
